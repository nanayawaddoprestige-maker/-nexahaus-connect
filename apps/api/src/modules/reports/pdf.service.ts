...
export class PdfService {
  statementReport(data: StatementReportData): Promise<Buffer> {
    ...
    doc
      ...
      .fontSize(9)
      .font("Helvetica")
      .text("PROPERTIES & ASSET MANAGEMENT", 50, 54);
    doc
      .fillColor("#FFFFFF")
      .fontSize(13)
      .font("Helvetica-Bold")
      .text("Owner Statement", 50, 30, {
        align: "right",
    ...
    doc
      ...
      .fontSize(11)
      .font("Helvetica-Bold")
      .text(data.ownerName, 50, y);
    doc
      .fillColor(MUTED)
      .fontSize(9)
      .font("Helvetica")
      .text(`${data.propertyLabel} · ${data.periodLabel}`, 50, y + 16);
    y += 44;
    ...
    const row = (
      ...
      doc
        .fillColor(INK)
        .font(opts.bold ? "Helvetica-Bold" : "Helvetica")
        .text(fmtMoney(minor, data.currency), 350, y, {
    ...
    row("Opening balance", data.openingBalanceMinor, {
      bold: true,
      rule: true,
    });
    ...
    row("Closing balance", data.closingBalanceMinor, {
      bold: true,
      rule: true,
    });
    ...
    for (const line of data.lines) {
      ...
      doc
        .fillColor(line.direction === "CREDIT" ? "#0F766E" : INK)
  ...
  rescueReport(data: RescueReportData): Promise<Buffer> {
    ...
    doc
      ...
      .fontSize(13)
      .font("Helvetica-Bold")
      .text("Property Rescue Report", 50, 30, {
        align: "right",
        width: doc.page.width - 100,
      });
    doc
    ...
    doc
      ...
      .fontSize(8)
      .font("Helvetica-Bold")
      .text("OVERALL SCORE", 62, y + 12);
    doc
      .fillColor(scoreColor)
      .fontSize(26)
      .font("Helvetica-Bold")
      .text(`${data.overallScore}/100`, 62, y + 24);
    y += 80;
    ...
    for (const p of data.problems) {
      ...
      doc
        ...
        .fontSize(9)
        .font("Helvetica")
        .text(p, 66, y, { width: doc.page.width - 120 });
      y += 16;
    }
    if (data.problems.length === 0) {
      doc
        .fillColor(MUTED)
        .fontSize(9)
        .text("No material problems detected.", 66, y);
      y += 16;
    }
    ...
    data.recommendations.forEach((r, i) => {
      ...
      doc
        ...
        .fontSize(10)
        .font("Helvetica-Bold")
        .text(`${i + 1}. ${r.title}`, 50, y, { width: doc.page.width - 100 });
      doc
        .fillColor(MUTED)
        .fontSize(8)
        .font("Helvetica-Bold")
        .text(r.priority, 50, y + 13);
      doc
        .fillColor(MUTED)
        .fontSize(9)
        .font("Helvetica")
        .text(r.detail, 50, y + 26, { width: doc.page.width - 100 });
      y += 52;
    });
  ...
  inspectionReport(data: InspectionReportData): Promise<Buffer> {
    ...
    for (const [k, v] of meta) {
      doc
        .fillColor(MUTED)
        .font("Helvetica")
        .text(k.toUpperCase(), 50, y, { width: 140 });
    ...
    doc
      ...
      .fontSize(12)
      .font("Helvetica-Bold")
      .text("Area-by-area findings", 50, y);
    y += 22;
    ...
    for (const item of data.items) {
      ...
      doc
        ...
        .fontSize(10)
        .font("Helvetica-Bold")
        .text(`${titleCase(item.area)} — ${item.label}`, 66, y, {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica-Bold")
        .text(item.rating.replace(/_/g, " "), 66, y + 14);
      if (item.note) {
        doc
          .fillColor(MUTED)
          .fontSize(9)
          .font("Helvetica")
          .text(`Note: ${item.note}`, 66, y + 26, {
            width: doc.page.width - 120,
          });
      }
