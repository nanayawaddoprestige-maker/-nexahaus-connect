...
export function scoreRescue(a: RescueAnswers): RescueResult {
  const parts: {
  ...
  }[] = [
    {
      ...
      note: (lost) =>
        lost > 8
          ? "Vacancy is the biggest drag on income."
          : "Occupancy is broadly healthy.",
    },
    {
      area: "Rental pricing",
      max: 12,
      ...
      note: (lost) =>
        lost > 6
          ? "Rent looks out of step with the market — worth a review."
          : "Rent looks about right.",
    },
    {
      area: "Rent collection",
      max: 16,
      got: { ALWAYS: 16, USUALLY: 11, SOMETIMES: 5, RARELY: 1 }[
        a.collectionReliability
      ],
      note: (lost) =>
        lost > 6
          ? "Collection is unreliable — a process gap."
          : "Collection is mostly reliable.",
    },
    {
      area: "Arrears",
      max: 8,
      ...
      note: (lost) =>
        lost > 0
          ? "Outstanding arrears need a recovery plan."
          : "No arrears reported.",
    },
    {
      area: "Maintenance backlog",
      max: 14,
      got: { NONE: 14, MINOR: 10, SIGNIFICANT: 4, SEVERE: 0 }[
        a.maintenanceBacklog
      ],
      note: (lost) =>
        lost > 6
          ? "A maintenance backlog is eroding condition and value."
    ...
    },
    {
      ...
      note: (lost) =>
        lost > 0
          ? "Condition concerns were flagged."
          : "No condition concerns reported.",
    },
    {
      area: "Inspections",
      max: 8,
      got: { WITHIN_3M: 8, WITHIN_12M: 6, OVER_12M: 2, NEVER: 0 }[
        a.lastInspection
      ],
      note: (lost) =>
        lost > 4
    ...
    },
    {
      ...
      note: (lost) =>
        lost > 0
          ? "Key documents are not in order."
    ...
    },
    {
      ...
      note: (lost) =>
        lost > 0
          ? "No professional management in place."
    ...
    },
    {
      ...
      note: (lost) =>
        lost > 0
          ? "Operating costs are not clearly known."
