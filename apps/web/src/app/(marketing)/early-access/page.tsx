  ...
  return (
    <div className="bg-surface">
      <Container className="py-10">
        <Breadcrumbs
          trail={[{ label: "Early Access", href: routes.earlyAccess }]}
        />
      </Container>
      ...
      <Container className="grid gap-12 pb-20 pt-2 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <p className="mt-4 text-ink-muted">
            ...
            {LAUNCH.label}. The work starts before the doors open — we are
            speaking with property owners now to understand the real challenges
            they face and build our services around those needs.
          </p>
