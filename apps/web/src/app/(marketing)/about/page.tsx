...
export const metadata: Metadata = buildMetadata({
  ...
  keywords: [
    ...
    "property management company Ghana",
  ],
});
...
const VALUES: [string, string][] = [
  [
    "Integrity",
    "We do what we say, and we say what is true — including when it is inconvenient.",
  ],
  [
    "Professionalism",
    "Structured processes and clear standards, not ad-hoc caretaking.",
  ],
  [
    "Transparency",
    "Owners can see what is happening and reconcile every figure.",
  ],
  [
    "Accountability",
    "Every decision, approval and action is recorded and owned.",
  ],
  ["Excellence", "The work is done properly the first time and checked."],
  [
    "Innovation",
    "We use technology to give owners visibility they could not get before.",
  ],
  ["Client focus", "The owner's asset and the owner's confidence come first."],
  [
    "Responsibility",
    "We treat someone's property as if the outcome were ours.",
  ],
];
    ...
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="rounded-2xl border border-line bg-surface p-8 shadow-card">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-ink-muted">
              To provide professional, transparent and technology-enabled
              property and asset management services that protect properties,
              improve performance and give owners confidence.
            </p>
          </div>
          <div className="rounded-2xl border border-line bg-surface p-8 shadow-card">
            <h2 className="text-sm font-semibold uppercase tracking-wide text-gold-600">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-ink-muted">
              To become one of Ghana&rsquo;s most trusted and technology-enabled
      ...
      <Section>
        ...
        <div className="nx-prose mt-6">
          <p>
            {COMPANY.legalName} is a modern, professional property and asset
            management company built to help property owners protect their
            properties, improve rental performance and manage their assets with
            confidence.
          </p>
          <p>
            Our approach combines professional property management, structured
            maintenance, transparent reporting, technology and an
            asset-performance mindset. For property owners living outside Ghana,
            we provide the visibility and accountability needed to manage
            property from wherever you are.
          </p>
          <p>
            Our technology platform, {COMPANY.product}, is being built to give
            clients secure digital access to their property information,
            financial updates, maintenance activity, inspection reports,
            documents and portfolio performance.
          </p>
          <p>
            Our first office is scheduled to open in {LAUNCH.city} in{" "}
            {LAUNCH.label}. NexaHaus does not provide legal, valuation, tax or
            investment advice, and regulated real-estate agency activities are
            offered only where NexaHaus holds the required Ghanaian licensing
