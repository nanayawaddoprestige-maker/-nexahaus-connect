...
export const metadata: Metadata = buildMetadata({
  ...
  keywords: [
    "property management platform Ghana",
    "property management software Ghana",
    "property technology Ghana",
  ],
});
...
const FEATURES = [
  {
    ...
    body: "Every property in one view — occupancy, rent, maintenance and Portfolio Health.",
  },
  {
    title: "Property profiles",
    body: "The full picture for each property: units, tenants, leases, documents and activity.",
  },
  {
    title: "Rent & finance",
    body: "What was expected, collected and outstanding, with monthly owner statements.",
  },
  {
    title: "Maintenance tracking",
    body: "Issues from first report to completion, with photos and vendor detail.",
  },
  {
    title: "Inspections",
    body: "Scheduled inspections with area-by-area findings, photos and a branded report.",
  },
  {
    title: "Documents",
    body: "Title, tenancy, insurance and inspection documents stored privately, with expiry reminders.",
  },
  {
    title: "Owner approvals",
    body: "Review costs and photos and approve or decline from your phone.",
  },
  {
    title: "Notifications",
    body: "Told about the things that matter — approvals, arrears, expiries — not noise.",
  },
  {
    title: "Reports",
    body: "Portfolio reporting with filters, date ranges and CSV export.",
  },
  {
    title: "Property Health",
    body: "A 0–100 read per property and across the portfolio, updated as things change.",
  },
  {
    title: "Asset performance",
    body: "Income, expenses, occupancy and estimated yield — actuals and estimates clearly labelled.",
  },
];
  ...
  return (
    <>
      ...
      <Section tone="sunken">
        <SectionHeader
          eyebrow="Features"
          title="Built around one question: what is happening with my property?"
        />
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <div>
            ...
            <div className="nx-prose mt-4">
              <p>
                Your property information belongs to you. NexaHaus Connect is
                being built with access controls, encryption in transit, audit
                logging and least-privilege access. Documents are stored
                privately and are never exposed through public links.
              </p>
              <p>
                The platform is designed to support compliance with
                Ghana&rsquo;s Data Protection Act, 2012 (Act 843). See our{" "}
      ...
      <Section tone="navy" ariaLabel="Access NexaHaus Connect">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="nx-display text-display-md text-white">
            Coming with the {COMPANY.shortName} launch.
          </h2>
          <p className="mt-3 text-navy-100">
            NexaHaus Connect is being built now and rolls out to clients as
            NexaHaus onboards them. Join Early Access to be among the first.
          </p>
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <Cta
              ...
              eventProps={{ location: "connect_page" }}
            >
              Join Early Access
            </Cta>
