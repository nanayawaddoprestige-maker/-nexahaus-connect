  ...
  return (
    <Section id="nexahaus-connect">
      <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
        <div>
          <SectionHeader eyebrow={connect.eyebrow} title={connect.headline} lede={connect.body} />
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Cta href={connect.primary.href} size="lg" event="connect_preview_viewed" eventProps={{ location: "home" }}>
