  ...
  return (
    <Section tone="sunken" id="property-rescue">
      <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-center">
        <div>
          <SectionHeader eyebrow={rescue.eyebrow} title={rescue.headline} lede={rescue.body} />
        ...
        <div className="flex flex-col items-center rounded-2xl border border-line bg-surface p-8 shadow-card">
          <HealthGauge score={rescue.exampleScore} caption={rescue.exampleLabel} />
          <p className="mt-3 text-center text-xs text-ink-subtle">
            A Property Rescue assessment produces an overall score and a ranked list of
            corrective actions.
          </p>
        </div>
      </div>
