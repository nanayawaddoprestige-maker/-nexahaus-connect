      ...
      <Container className="grid gap-12 pb-20 pt-2 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <p className="mt-4 text-ink-muted">
            Six short steps, about two minutes. You&rsquo;ll get a preliminary
            Property Health Score straight away, plus the areas most likely to
            need attention.
          </p>
          ...
          <p className="mt-6 max-w-prose text-xs text-ink-subtle">
            The Property Health Score is a NexaHaus management assessment
            framework. It is a preliminary digital assessment based on your own
            answers — not a professional property assessment, valuation, legal
