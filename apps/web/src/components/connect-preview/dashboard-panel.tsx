...
export function DashboardPanel() {
  return (
    <ConnectFrame title="NexaHaus Connect — Dashboard" sidebar={<ModuleRail active="Dashboard" />}>
      <h3 className="text-base font-semibold text-navy-900">Portfolio overview</h3>
      <p className="text-xs text-ink-subtle">5 properties · 18 units · September 2026</p>
      ...
      <div className="mt-3 flex items-center justify-between text-xs">
        <span className="text-ink-subtle">86% of expected rent collected this period</span>
        <span className="font-medium text-navy-800">Portfolio Health 87/100</span>
      </div>

      <div className="mt-4 rounded-lg border border-line p-3">
        <p className="text-xs font-medium text-ink-subtle">Needs your attention</p>
