...
export function StatementPanel() {
  return (
    <ConnectFrame
      title="NexaHaus Connect — Owner statement"
      sidebar={<ModuleRail active="Finance" />}
    >
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <h3 className="text-base font-semibold text-navy-900">
            Owner statement — August 2026
          </h3>
          <p className="text-xs text-ink-subtle">
            Cantonments Court, Block B · NH-000142 · ST-2026-08
          </p>
        </div>
      ...
      <dl className="mt-4">
        ...
        <Row
          label="Brought forward (arrears)"
          value="GHS 1,500"
          tone="warning"
        />

        <p className="mt-3 text-[11px] font-semibold uppercase tracking-wide text-ink-subtle">
          Deductions
        </p>
